...
class SmartObject:
    ...
    def parse_info_values(self, l):
        ...
        if l[:13] == 'Device Model:' or l[:7] == 'Device:' or l[:8] == 'Product:':
            ...
            print('smarttools: iv:captured ATA Security status: {}'.format(self.disk_information["ata_security"]))
    ...
    def parse_lines(self):
        ...
        for l in self.smart_input:
            ...
            if l[:37] == 'SATA Phy Event Counters (GP Log 0x11)':
                self.set_mode(39)  # SATA: Switch to SATA Physical Event Counter Mode
            ...
            if l[:45] == 'Index    Estimated Time   Temperature Celsius':
                ...
                self.next_block_mode = 48  # Go back to block mode 28 afterwards.
...
if __name__ == '__main__':
    ...
    if options.force or prompt(
        ...
        # Do Stuff Here
        the_disk = SmartObject(options.input, values)
        # And Here
